...
class Vendo
{
    private const STATUS_DUAL_DELIVERY_APPLICATION_ID_NOT_FOUND = 20;

    /**
     * Addressierbarkeit wird geprüft.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P1 = 21;

    /**
     * Datenanreicherung des Geschäftsfalles.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P2 = 22;

    /**
     * Geschäftsfall wird zugestellt.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P3 = 23;
     ...
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P4 = 24;
     ...
     * Der Geschäftsfall wurde von der Applikation an den Zustellservice übertragen.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P5 = 25;

    /**
     * Alle Nachweise erhalten von allen Kanälen.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P6 = 26;

    /**
     * Geschäftfall wird verarbeitet.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P7 = 27;
     ...
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P8 = 28;
     ...
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P9 = 29;
     ...
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P10 = 30;

    /**
     * Nachweise befindet sich im Zulauf.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P11 = 31;

    /**
     * Fehler aufgetreten, bitte kontaktieren Sie den Support.
     */
    private const STATUS_DUAL_DELIVERY_STATUS_P12 = 32;
    ...
    public static function getStatusTypeDescription(int $status): string
    {
        ...
        $descriptions = [
            self::STATUS_DUAL_DELIVERY_APPLICATION_ID_NOT_FOUND => 'ApplicationID wurde nicht gefunden',
            self::STATUS_DUAL_DELIVERY_STATUS_P1 => 'P1: Addressierbarkeit wird geprüft',
            self::STATUS_DUAL_DELIVERY_STATUS_P2 => 'P2: Datenanreicherung des Geschäftsfalles',
            self::STATUS_DUAL_DELIVERY_STATUS_P3 => 'P3: Geschäftsfall wird zugestellt',
            self::STATUS_DUAL_DELIVERY_STATUS_P4 => "P4: Geschäftsfall teilweise zugestellt\nDer Geschäftsfall wurde von der Applikation an den Zustellservice übertragen. Keine Bestätigung vom Zustelldienst erhalten, ein erneuter Versuch erfolgt.",
            self::STATUS_DUAL_DELIVERY_STATUS_P5 => "P5: Geschäftsfall erfolgreich übermittelt\nDer Geschäftsfall wurde von der Applikation an den Zustellservice übertragen.",
            self::STATUS_DUAL_DELIVERY_STATUS_P6 => 'P6: Alle Nachweise erhalten von allen Kanälen',
            self::STATUS_DUAL_DELIVERY_STATUS_P7 => 'P7: Geschäftfall wird verarbeitet',
            self::STATUS_DUAL_DELIVERY_STATUS_P8 => "P8: Empfänger konnte nicht ermittelt werden\nnegative Antwort vom zentralen Adressverzeichnis (Zustellkopf), mit den übergebenen Informationen konnte keine eindeutige Person identifiziert werden",
            self::STATUS_DUAL_DELIVERY_STATUS_P9 => "P9: Zustellung konnte nicht erfolgreich verarbeitet/zugestellt werden\nMögliche Gründe: fehlende Adressierungsmerkmale, keine Fristgerechte Antwort von Druckstrasse erhalten.",
            self::STATUS_DUAL_DELIVERY_STATUS_P10 => "P10: Geschäftfall erfolgreich zugestellt\nGeschäftsfall ist beim Empfängerpostfach am Zustelldienst hinterlegt bzw. von der Druckstrasse produziert worden.",
            self::STATUS_DUAL_DELIVERY_STATUS_P11 => 'P11: Nachweise befindet sich im Zulauf',
            self::STATUS_DUAL_DELIVERY_STATUS_P12 => 'P12: Fehler aufgetreten, bitte kontaktieren Sie den Support',
        ];
    ...
    public static function getStatusForCode(string $code): int
    {
        ...
        switch ($code) {
            case '17':
                $statusType = self::STATUS_DUAL_DELIVERY_APPLICATION_ID_NOT_FOUND;
                break;
            case 'P1':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P1;
                break;
            case 'P2':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P2;
                break;
            case 'P3':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P3;
                break;
            case 'P4':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P4;
                break;
            case 'P5':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P5;
                break;
            case 'P6':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P6;
                break;
            case 'P7':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P7;
                break;
            case 'P8':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P8;
                break;
            case 'P9':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P9;
                break;
            case 'P10':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P10;
                break;
            case 'P11':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P11;
                break;
            case 'P12':
                $statusType = self::STATUS_DUAL_DELIVERY_STATUS_P12;
                break;
        }

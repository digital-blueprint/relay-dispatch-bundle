...
class Configuration implements ConfigurationInterface
{
    ...
    private function getAuthNode(): NodeDefinition
    {
        ...
        ->addRole(self::ROLE_GROUP_WRITER_READ_ADDRESS, 'false', 'Returns true if the user has write access for the given group and can read recipient addresses. Implies all reader/writer roles.')

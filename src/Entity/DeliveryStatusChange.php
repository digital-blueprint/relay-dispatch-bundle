...
class DeliveryStatusChange
{
    ...
    const STATUS_DUAL_DELIVERY_STATUS_P1 = 21;
    const STATUS_DUAL_DELIVERY_STATUS_P2 = 22;
    const STATUS_DUAL_DELIVERY_STATUS_P3 = 23;
    const STATUS_DUAL_DELIVERY_STATUS_P4 = 24;
    const STATUS_DUAL_DELIVERY_STATUS_P5 = 25;
    const STATUS_DUAL_DELIVERY_STATUS_P6 = 26;
    const STATUS_DUAL_DELIVERY_STATUS_P7 = 27;
    const STATUS_DUAL_DELIVERY_STATUS_P8 = 28;
    const STATUS_DUAL_DELIVERY_STATUS_P9 = 29;
    const STATUS_DUAL_DELIVERY_STATUS_P10 = 30;
    const STATUS_DUAL_DELIVERY_STATUS_P11 = 31;
    const STATUS_DUAL_DELIVERY_STATUS_P12 = 32;
